...
class Hangman {
    constructor(list) {
        this.randNumber = randNumber(list)
        this.vocabulary = vocabulary(list, this.randNumber)
...
//   const guessCharacter = String.fromCharCode(e.charCode)
//    console.log(hangman1.makeGauess(guessCharacter))
//})